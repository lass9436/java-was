...
VALUES ('kimc', '첫 번째 포스트', '이것은 첫 번째 포스트의 내용입니다.', 'image1.jpg'),
       ('leeyh', '두 번째 포스트', '이것은 두 번째 포스트의 내용입니다.', 'image2.jpg'),
       ('parkms', '세 번째 포스트', '이것은 세 번째 포스트의 내용입니다.', 'image3.jpg'),
       ('choijw', '네 번째 포스트', '이것은 네 번째 포스트의 내용입니다.', 'image4.jpg'),
       ('hanys', '다섯 번째 포스트', '이것은 다섯 번째 포스트의 내용입니다.', 'image5.jpg');
